...
nii_path = "/ssd/wanghuayi/HW/FLARE22Train/FLARE22Train/images"  # path to the nii images
gt_path = "/ssd/wanghuayi/HW/FLARE22Train/FLARE22Train/labels"  # path to the ground truth
...
for name in tqdm(names[40:]):  # use the remaining 10 cases for validation
    ...
    gt_name = name
    gt_sitk = sitk.ReadImage(join(gt_path, gt_name, gt_name))
