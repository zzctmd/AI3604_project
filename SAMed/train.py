...
parser.add_argument('--root_path', type=str,
                    default='../dataset/Synapse_12/train_npz', help='root dir for data')#要改动
parser.add_argument('--output', type=str, default='../output/Synapse/12')#要改动
parser.add_argument('--dataset', type=str,
                    default='Synapse_12', help='experiment_name')#要改动
parser.add_argument('--list_dir', type=str,
                    default='./lists/list_Synapse12', help='list dir')#要改动
...
parser.add_argument('--module', type=str, default='sam_lora_image_encoder')#可改动
...
if __name__ == "__main__":
    ...
    trainer = {'Synapse_12': trainer_synapse}
