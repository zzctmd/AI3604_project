...
parser.add_argument('--root_path', type=str,
                    default='../dataset/FLARE/trainset/train_npz', help='root dir for data')#要改动
parser.add_argument('--output', type=str, default='../output/FLARE/mask_decoder')#要改动
parser.add_argument('--dataset', type=str,
                    default='FLARE', help='experiment_name')#要改动
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_FLARE', help='list dir')#要改动
...
parser.add_argument('--module', type=str, default='sam_lora_image_encoder_mask_decoder')#可改动
